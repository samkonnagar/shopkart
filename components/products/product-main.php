...
$sql = "SELECT p.product_id, p.images, p.product_name, c.category_name, p.price_per_unit FROM `category` c join products p on c.category_id = p.category_id order by p.created_at desc LIMIT 12";
